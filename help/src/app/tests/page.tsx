...
const Tests = () => {
  ...
  return (
    <div>
      <h1 className="firstItem">Tests</h1>
      <Link href={`#toHelpCommands`}>Help Commands</Link>
      <Text
        html={`
    ...
    <p>Test commands can create and utilize variables with arbitrary values during the execution of the command package.
      ...
      />
      <Text
        html={`<p>Output this command looks as :</p>
        <pre>
    {
    ...
    response ={
      ...
      />
      <CmdLine
        cmd={`<div class="cm-activeLine cm-line">{<span class="ͼ1m">"command"</span>:<span class="ͼ19">"portfolios.list"</span>, <span class="ͼ1m">"filter"</span>: {<span class="ͼ1m">"name"</span>:<span class="ͼ19">"_testErrorInputPortfolio"</span>}, <span class="ͼ1m">"_as"</span>:<span class="ͼ19">"result"</span>}</CmdLinediv>`}
      />
      <Text
        html={` create variable with name 'result' and type array from field 'data':
        <pre>
    {
...
`}
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            <CmdLine
              cmd={`<div class="cm-activeLine cm-line">{<span class="ͼ1m">"command"</span>:<span class="ͼ19">"tests.check"</span>, <span class="ͼ1m">"path"</span>: <span class="ͼ19">"result.0"</span>, <span class="ͼ1m">"conditions"</span>: {<span class="ͼ1m">"name"</span>: {<span class="ͼ1m">"$eq"</span>: <span class="ͼ19">"_testErrorInputPortfolio"</span>}},  <span class="ͼ1m">"description"</span>: <span class="ͼ19">"Check porfolio with requested name"</span>}</div>`}
            />
          </td>
        </tr>
        <tr>
          ...
          <td>
            <CmdLine
              cmd={`<div class="cm-line">{<span class="ͼ1m">"command"</span>: <span class="ͼ19">"tests.setVar"</span>, <span class="ͼ1m">"v"</span>:{<span class="ͼ1m">"pid"</span>: <span class="ͼ19">"$var.result.0._id"</span> }}</div>`}
            />
          </td>
        </tr>
        <tr>
          <td>Variable array property insex access</td>
          <td>For array property in variable can be used acces by index .1.</td>
          <td></td>
        </tr>
        <tr>
          <td>Variable array property </td>
          <td>
            For array property in variable can be used find as [symbol=INTC]
          </td>
          <td>
            <CmdLine
              cmd={`<div class="cm-line">{<span class="ͼ1m">"command"</span>: <span class="ͼ19">"tests.getVar"</span>,<span class="ͼ1m">"path"</span>:<span class="ͼ19">"position2.[symbol=XLC].weight"</span>}</div>`}
            />
          </td>
        </tr>
      </table>
      ...
      <ul>
        <li>
          <b>tests_portfolio.add</b>: Tests with portfolio add operations
        </li>
        <li>
          <b>tests_portfolio.remove</b>: Tests with portfolio remove operations
        </li>
        <li>
          <b>tests_portfolio.history</b>: Tests with portfolio history
          operations
        </li>
        <li>
          <b>tests_portfolio.positions</b>: Tests with portfolio positions
          operations
        </li>
      </ul>
      <table>
        ...
        <tr>
          <td>
            <Link href="#to-check">Check</Link>
          </td>
          <td>
            <CmdLine
              cmd={`<div class="cm-activeLine cm-line">{<span class="ͼ1m">"command"</span>:<span class="ͼ19">"tests.check"</span>,<span class="ͼ1m">"path"</span>:<span class="ͼ19">"?"</span>,<span class="ͼ1m">"conditions"</span>:{}}</div>`}
            />
          </td>
        </tr>
        <tr>
          <td>
            <Link href="./commands/tests/#to-setVar">Set variable</Link>
          </td>
          <td>
            <CmdLine
              cmd={`<div class="cm-line">{<span class="ͼ1m">"command"</span>:<span class="ͼ19">"tests.setVar"</span>,<span class="ͼ1m">"v"</span>:<span class="ͼ19">"?"</span>}</div>`}
            />
            `
          </td>
        </tr>
        <tr>
          <td>
            <Link href="./commands/tests/#to-getVar">Get variable</Link>
          </td>
          <td>
            <CmdLine
              cmd={`<div class="cm-line">{<span class="ͼ1m">"command"</span>:<span class="ͼ19">"tests.getVar"</span>,<span class="ͼ1m">"path"</span>:<span class="ͼ19">"?"</span>}</div>`}
            />
          </td>
        </tr>
        <tr>
          <td>
            <Link href="./commands/tests/#to-setMode">Set output mode</Link>
          </td>
          <td>
            <CmdLine
              cmd={`<div class="cm-line">{<span class="ͼ1m">"command"</span>:<span class="ͼ19">"tests.setMode"</span>,<span class="ͼ1m">"hide"</span>:<span class="ͼ1b">true</span>}</div>`}
            />
          </td>
        </tr>
      </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td>Object which contain conditions for check varible defined by path
                ...
                For $eq number comparation will be used precision from $eq value. When $eq = 1.0000 then comparable value also be comnveredt to value with 4 digitrs.
            </td>
            <td>Yes</td>
        </tr>
        <tr>
...
`}
      ...
      <table>
        ...
        <tr>
          <td>Break Test sequence</td>
          <td>
            <CmdLine
              cmd={`<div class="cm-line">{<span class="ͼ1m">"command"</span>:<span class="ͼ19">"tests.breakTests"</span>}</div>`}
            />
          </td>
        </tr>
        <tr>
